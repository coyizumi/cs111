/*	$FreeBSD: releng/10.2/sys/dev/usb/wlan/if_ural.c 269266 2014-07-29 21:59:24Z hselasky $	*/
...
#include <sys/cdefs.h>
__FBSDID("$FreeBSD: releng/10.2/sys/dev/usb/wlan/if_ural.c 269266 2014-07-29 21:59:24Z hselasky $");
