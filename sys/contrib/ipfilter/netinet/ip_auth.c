/*	$FreeBSD: releng/10.2/sys/contrib/ipfilter/netinet/ip_auth.c 266829 2014-05-29 02:55:07Z cy $	*/
...
#if !defined(lint)
static const char rcsid[] = "@(#)$FreeBSD: releng/10.2/sys/contrib/ipfilter/netinet/ip_auth.c 266829 2014-05-29 02:55:07Z cy $";
